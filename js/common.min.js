...
!function(e){WebFont.load({google:{families:["Open Sans"]}}),e(".slider").slick({accessibility:!1,slideToScroll:!0,autoplay:!0,infinite:!0,mobileFirst:!0,swipe:!0,adaptiveHeight:!0,dots:!1,responsive:[{breakpoint:992,settings:{dots:!0}}]}),e(".product-slide__slide-envelope").slick({slidesToShow:1,slideToScroll:!0,autoplay:!0,infinite:!0,mobileFirst:!0,swipe:!0});var a=e(".form-connect__input"),n=e('[data-remodal-id="form-modal"]').remodal();e(".form-connect__btn-send").on("click",function(){for(var e=0;e<a.length;e++)""!=a[e].value&&n.open()}),e(".input-phone").mask("(000)-00-000-00"),e("#nav-icon1").on("click",function(){e(this).toggleClass("open"),e(this).hasClass("open")?e(".header__menu__wrap--menu").stop(!0).animate({left:"0"},700):e(".header__menu__wrap--menu").stop(!0).animate({left:"-100%"},700),e(".header__menu__wrap--search input").hide()}),e(".header__menu__wrap--search a").on("click",function(a){a.preventDefault(),e(this).next().stop(!0).fadeToggle(),e(".header__menu__wrap--menu").stop(!0).animate({left:"-100%"},700),e("#nav-icon1").removeClass("open")}),e(window).on("load resize",function(){e(window).width()>="776"&&(e("#nav-icon1").removeClass("open"),e(".header__menu__wrap--menu").stop(!0).animate({left:"-100%"},700),e(".header__menu__wrap--search input").hide())}),e(".header__contacts__wrap--language a, .footer__wrap__menu__data__other--language a").on("click",function(a){a.preventDefault(),e(this).parent().children().removeClass("active"),e(this).addClass("active")}),e(".header__menu__wrap--menu--item a, .footer__wrap__menu__data__other--item a").on("click",function(a){a.preventDefault(),e(this).parent().parent().children().children().removeClass("active"),e(this).addClass("active")});var t=e('[data-remodal-id="form-callback"]').remodal();e(".header__contacts__wrap--callback a, .footer__wrap__menu__data__others--callback a").on("click",function(e){e.preventDefault(),t.open()})}(jQuery);