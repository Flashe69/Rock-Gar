...
function initMap(){map=new google.maps.Map(document.getElementById("map"),{center:{lat:52.174,lng:32.847},zoom:3});new google.maps.Marker({position:{lat:59.889,lng:30.478},map:map}),new google.maps.Marker({position:{lat:51.127,lng:4.948},map:map}),new google.maps.Marker({position:{lat:50.905,lng:6.797},map:map})}!function(e){function n(){e(window).scrollTop()>60?(r.addClass("fixed"),e(".fixed-menu").css("margin-top",60)):(r.removeClass("fixed"),e(".fixed-menu").css("margin-top",0))}function a(){e(window).scrollTop()>60&&(r.removeClass("fixed"),e(".fixed-menu").css("margin-top",0))}WebFont.load({google:{families:["Open Sans"]}}),e(".slider").slick({accessibility:!1,slideToScroll:!0,autoplay:!0,infinite:!0,mobileFirst:!0,swipe:!0,adaptiveHeight:!0,dots:!1,responsive:[{breakpoint:992,settings:{dots:!0}}]});var i=e(".navigation-btn__next"),t=e(".navigation-btn__prev");e(".product-slide__slide-envelope").slick({slidesToShow:1,slideToScroll:!0,autoplay:!0,infinite:!0,mobileFirst:!0,swipe:!0,prevArrow:t,nextArrow:i}),i.on("mouseenter",function(){e(this).children().css("color","#3f64ae","transition","all .7s ease"),e(this).find(".navigation-btn__info").children().css("color","#3f64ae","transition","all .7s ease")}),i.on("mouseleave",function(){e(this).children().css("color","#999"),e(this).find(".navigation-btn__info").children().css("color","#999")}),t.on("mouseenter",function(){e(this).children().css("color","#3f64ae","transition","all .7s ease"),e(this).find(".navigation-btn__info").children().css("color","#3f64ae","transition","all .7s ease")}),t.on("mouseleave",function(){e(this).children().css("color","#999"),e(this).find(".navigation-btn__info").children().css("color","#999")});var o=e(".slider-modal").remodal();e(".envelope-dataPicture__img").on("click",function(){o.open(),e(".slider-modalEnvelope").slick({slidesToShow:1,slideToScroll:!0,autoplay:!0,infinite:!0,mobileFirst:!0,swipe:!0,prevArrow:'<div class="slick-prev modalLeft"><i class="fa fa-angle-left"></i></div>',nextArrow:'<div class="slick-next modalRight"><i class="fa fa-angle-right"></i></div>'})});var s=e(".form-connect__input"),l=e('[data-remodal-id="form-modal"]').remodal();e(".form-connect__btn-send").on("click",function(){for(var e=0;e<s.length;e++)""!=s[e].value&&l.open()}),e(".input-phone").mask("(000)-00-000-00"),e(".envelope-dataPicture__miniatures").find("img").on("click",function(){e(".envelope-dataPicture__img").attr("src",e(this).attr("src"))}),e(".info-order__btn").on("click",function(n){n.preventDefault(),e(".active-btn__bag").removeClass("active-btn__bag"),e(this).addClass("active-btn__bag")}),e("#nav-icon1").on("click",function(){e(this).toggleClass("open"),e(this).hasClass("open")?e(".header__menu__wrap--menu").stop(!0).animate({left:"0"},700):e(".header__menu__wrap--menu").stop(!0).animate({left:"-100%"},700),e(".header__menu__wrap--search input").hide()});var r=e(".header__menu");e(window).on("load resize",function(){e(window).width()<="768"?e(window).on("scroll",n):(e(window).on("scroll",a),r.removeClass("fixed"))}),e(".header__menu__wrap--search a").on("click",function(n){n.preventDefault(),e(this).next().stop(!0).fadeToggle(),e(".header__menu__wrap--menu").stop(!0).animate({left:"-100%"},700),e("#nav-icon1").removeClass("open")}),e(window).on("load resize",function(){e(window).width()>="776"&&(e("#nav-icon1").removeClass("open"),e(".header__menu__wrap--menu").stop(!0).animate({left:"-100%"},700),e(".header__menu__wrap--search input").hide())}),e(".header__contacts__wrap--language a, .footer__wrap__menu__data__other--language a").on("click",function(n){e(this).parent().children().removeClass("active"),e(this).addClass("active")}),e(".header__menu__wrap--menu--item a, .footer__wrap__menu__data__other--item a").on("click",function(n){e(this).parent().parent().children().children().removeClass("active"),e(this).addClass("active")});var c=e('[data-remodal-id="form-callback"]').remodal();e(".header__contacts__wrap--callback a, .footer__wrap__menu__data__others--callback a").on("click",function(e){e.preventDefault(),c.open()}),e(".buttons").on("click",function(n){n.preventDefault(),e(this).addClass("active_btn"),e(this).parent().siblings().children().removeClass("active_btn")}),e(".arrow_left").on("click",function(){var n=e(".active_btn"),a=e(".first");n.parent().hasClass("first")?a.children().addClass("active_btn"):(n.removeClass("active_btn"),n.parent().prev().children().addClass("active_btn"))}),e(".arrow_right").on("click",function(){var n=e(".active_btn"),a=e(".last");n.parent().hasClass("last")?a.children().addClass("active_btn"):(n.removeClass("active_btn"),n.parent().next().children().addClass("active_btn"))})}(jQuery);var map;