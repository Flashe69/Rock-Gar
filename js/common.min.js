!function (e, t) {
  ...
  function b(e, t, n, r, i) {
    ...
    for (f.textContent = "", d = 0; o = p[d++];) if (r && de.inArray(o, r) > -1) i && i.push(o); else if (l = de.contains(o.ownerDocument, o), a = y(f.appendChild(o), "script"), l && x(a), n) for (c = 0; o = a[c++];) Xe.test(o.type || "") && n.push(o);
    return f
  }
  ...
  function A(e, t, r, i) {
    ...
    if (p && (o = b(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
      ...
      if (u) for (c = s[s.length - 1].ownerDocument, de.map(s, N), f = 0; f < u; f++) l = s[f], Xe.test(l.type || "") && !He.access(l, "globalEval") && de.contains(c, l) && (l.src ? de._evalUrl && de._evalUrl(l.src) : n(l.textContent.replace(nt, ""), c))
    }
    return e
  }
  ...
  function M(e, t, n) {
    var r, i = ot(e), o = L(e, t, i), a = "border-box" === de.css(e, "boxSizing", !1, i);
    return it.test(o) ? o : (r = a && (pe.boxSizingReliable() || o === e.style[t]), (o = parseFloat(o) || 0) + R(e, t, n || (a ? "border" : "content"), r, i) + "px")
  }
  ...
  function z(e, t) {
    var n, r, i, o, a;
    for (n in e) if (r = de.camelCase(n), i = t[r], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = de.cssHooks[r]) && "expand" in a) {
  ...
  function X(e, t, n) {
    var r, i, o = 0, a = X.prefilters.length, s = de.Deferred().always(function () {
      delete u.elem
    }), u = function () {
      if (i) return !1;
    ...
    for (z(c, l.opts.specialEasing); o < a; o++) if (r = X.prefilters[o].call(l, e, c, l.opts)) return de.isFunction(r.stop) && (de._queueHooks(l.elem, l.opts.queue).stop = de.proxy(r.stop, r)), r;
  ...
  de.fn = de.prototype = {
    jquery: "3.2.0", constructor: de, length: 0, toArray: function () {
      return re.call(this)
    }, get: function (e) {
    ...
    for ("boolean" == typeof a && (l = a, a = arguments[s] || {}, s++), "object" == typeof a || de.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++) if (null != (e = arguments[s])) for (t in e) n = a[t], a !== (r = e[t]) && (l && r && (de.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, o = n && Array.isArray(n) ? n : []) : o = n && de.isPlainObject(n) ? n : {}, a[t] = de.extend(l, o, r)) : void 0 !== r && (a[t] = r));
    return a
  }, de.extend({
    expando: "jQuery" + ("3.2.0" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
      throw new Error(e)
    }, noop: function () {
        ...
        TAG: function (e) {
          ...
          return 1 === r && 0 === i ? function (e) {
            ...
            if (v) {
              ...
              } else if (y && (x = d = (l = (c = (f = (p = t)[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === W && l[1]), !1 === x) for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && ((c = (f = p[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [W, x]), p !== t));) ;
  ...
  var He = new p, Fe = new p, Oe = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Pe = /[A-Z]/g;
  de.extend({
    hasData: function (e) {
  ...
  de.event = {
    global: {}, add: function (e, t, n, r, i) {
      ...
      if (v) for (n.handler && (n = (o = n).handler, i = o.selector), i && de.find.matchesSelector(Ge, i), n.guid || (n.guid = de.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
      ...
      if (v && (u = v.events)) {
        for (l = (t = (t || "").match(De) || [""]).length; l--;) if (s = Je.exec(t[l]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
      ...
      var t, n, r, i, o, a, s = de.event.fix(e), u = new Array(arguments.length),
          l = (He.get(this, "events") || {})[s.type] || [], c = de.event.special[s.type] || {};
      ...
      load: {noBubble: !0}, focus: {
        ...
        trigger: function () {
          if (_e.test(this.type) && this.click && i(this, "input")) return this.click(), !1
        }, _default: function (e) {
          return i(e.target, "a")
        }
      }, beforeunload: {
  ...
  de.extend({
    htmlPrefilter: function (e) {
      ...
      if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || de.isXMLDoc(e))) for (a = y(s), r = 0, i = (o = y(e)).length; r < i; r++) j(o[r], a[r]);
  ...
  var at = /^(none|table(?!-c[ea]).+)/, st = /^--/, ut = {position: "absolute", visibility: "hidden", display: "block"},
  ...
  de.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i, o, a, s = de.camelCase(t), u = st.test(t), l = e.style;
    ...
    de.cssHooks[t] = {
      get: function (e, n, r) {
        ...
        var i, o = r && ot(e), a = r && R(e, t, r, "border-box" === de.css(e, "boxSizing", !1, o), o);
    ...
    if (t) return (parseFloat(L(e, "marginLeft")) || e.getBoundingClientRect().left - $e(e, {marginLeft: 0}, function () {
  ...
  de.Animation = de.extend(X, {
    tweeners: {
      ...
      var r, i, o, a, s, u, l, c, f = "width" in t || "height" in t, p = this, d = {}, h = e.style,
          g = e.nodeType && We(e), v = He.get(e, "fxshow");
      ...
      if ((u = !de.isEmptyObject(t)) || !de.isEmptyObject(d)) {
        ...
        for (r in d) u || (v ? "hidden" in v && (g = v.hidden) : v = He.access(e, "fxshow", {display: l}), o && (v.hidden = !g), g && m([e], !0), p.done(function () {
  ...
  de.fn.extend({
    ...
    addClass: function (e) {
      ...
      if ("string" == typeof e && e) for (t = e.match(De) || []; n = this[u++];) if (i = V(n), r = 1 === n.nodeType && " " + U(i) + " ") {
      ...
      return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : de.isFunction(e) ? this.each(function (n) {
        ...
        var t, r, i, o;
        if ("string" === n) for (r = 0, i = de(this), o = e.match(De) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || ((t = V(this)) && He.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : He.get(this, "__className__") || ""))
      })
    }, hasClass: function (e) {
      var t, n, r = 0;
  ...
  de.fn.extend({
    val: function (e) {
      ...
      })) : i ? (t = de.valHooks[i.type] || de.valHooks[i.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : "string" == typeof(n = i.value) ? n.replace(bt, "") : null == n ? "" : n : void 0
    }
  }), de.extend({
    valHooks: {
      option: {
  ...
  de.extend(de.event, {
    trigger: function (t, n, r, i) {
      ...
      if (a = s = r = r || te, 3 !== r.nodeType && 8 !== r.nodeType && !wt.test(d + de.event.triggered) && (d.indexOf(".") > -1 && (d = (h = d.split(".")).shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[de.expando] ? t : new de.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : de.makeArray(n, [t]), f = de.event.special[d] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
        ...
        for (o = 0; (a = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, (c = (He.get(a, "events") || {})[t.type] && He.get(a, "handle")) && c.apply(a, n), (c = l && a[l]) && c.apply && Le(a) && (t.result = c.apply(a, n), !1 === t.result && t.preventDefault());
  ...
  var jt = /%20/g, At = /#.*$/, qt = /([?&])_=[^&]*/, Lt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
      Ht = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ft = /^(?:GET|HEAD)$/, Ot = /^\/\//, Pt = {},
      Rt = {}, Mt = "*/".concat("*"), It = te.createElement("a");
  It.href = Tt.href, de.extend({
    ...
    ajax: function (t, n) {
      ...
      var i, o, a, s, u, l, c, f, p, d, h = de.ajaxSetup({}, n), g = h.context || h,
          v = h.context && (g.nodeType || g.jquery) ? de(g) : de.event, m = de.Deferred(),
...
!function (e) {
  e.fn.marquee = function (t) {
    return this.each(function () {
      var i, a, n, r, s, o = e.extend({}, e.fn.marquee.defaults, t), u = e(this), d = 3, p = "animation-play-state",
          l = !1, c = function (e, t, i) {
      ...
      if ("string" == typeof t) e.isFunction(m[t]) && (i || (i = u.find(".js-marquee-wrapper")), !0 === u.data("css3AnimationIsSupported") && (l = !0), m[t]()); else {
        var g;
        ...
        v = u.find(".js-marquee").css({"margin-right": o.gap, float: "left"});
        ...
        } else s = u.find(".js-marquee:first").width() + o.gap, a = u.width(), o.startVisible && !o.duplicated ? (o._completeDuration = (parseInt(s, 10) + parseInt(a, 10)) / parseInt(a, 10) * o.duration, o.duration *= parseInt(s, 10) / parseInt(a, 10)) : o.duration *= (parseInt(s, 10) + parseInt(a, 10)) / parseInt(a, 10);
        if (o.duplicated && (o.duration /= 2), o.allowCss3Support) {
          var v = document.body || document.createElement("div"),
              I = "marqueeAnimation-" + Math.floor(1e7 * Math.random()), x = ["Webkit", "Moz", "O", "ms", "Khtml"],
              b = "animation", S = "", w = "";
          if (v.style.animation && (w = "@keyframes " + I + " ", l = !0), !1 === l) for (var q = 0; q < x.length; q++) if (void 0 !== v.style[x[q] + "AnimationName"]) {
            v = "-" + x[q].toLowerCase() + "-", b = v + b, p = v + p, w = "@" + v + "keyframes " + I + " ", l = !0;
            break
          }
          l && (S = I + " " + o.duration / 1e3 + "s " + o.delayBeforeStart / 1e3 + "s infinite " + o.css3easing, u.data("css3AnimationIsSupported", !0))
        }
        var j = function () {
        ...
        var V = function () {
          if (o.duplicated && (1 === d ? (o._originalDuration = o.duration, o.duration = r ? "up" == o.direction ? o.duration + h / (y / o.duration) : 2 * o.duration : "left" == o.direction ? o.duration + a / (s / o.duration) : 2 * o.duration, S && (S = I + " " + o.duration / 1e3 + "s " + o.delayBeforeStart / 1e3 + "s " + o.css3easing), d++) : 2 === d && (o.duration = o._originalDuration, S && (I += "0", w = e.trim(w) + "0 ", S = I + " " + o.duration / 1e3 + "s 0s infinite " + o.css3easing), d++)), r ? o.duplicated ? (2 < d && i.css("margin-top", "up" == o.direction ? 0 : "-" + y + "px"), n = {"margin-top": "up" == o.direction ? "-" + y + "px" : 0}) : o.startVisible ? 2 === d ? (S && (S = I + " " + o.duration / 1e3 + "s " + o.delayBeforeStart / 1e3 + "s " + o.css3easing), n = {"margin-top": "up" == o.direction ? "-" + y + "px" : h + "px"}, d++) : 3 === d && (o.duration = o._completeDuration, S && (I += "0", w = e.trim(w) + "0 ", S = I + " " + o.duration / 1e3 + "s 0s infinite " + o.css3easing), j()) : (j(), n = {"margin-top": "up" == o.direction ? "-" + i.height() + "px" : h + "px"}) : o.duplicated ? (2 < d && i.css("margin-left", "left" == o.direction ? 0 : "-" + s + "px"), n = {"margin-left": "left" == o.direction ? "-" + s + "px" : 0}) : o.startVisible ? 2 === d ? (S && (S = I + " " + o.duration / 1e3 + "s " + o.delayBeforeStart / 1e3 + "s " + o.css3easing), n = {"margin-left": "left" == o.direction ? "-" + s + "px" : a + "px"}, d++) : 3 === d && (o.duration = o._completeDuration, S && (I += "0", w = e.trim(w) + "0 ", S = I + " " + o.duration / 1e3 + "s 0s infinite " + o.css3easing), C()) : (C(), n = {"margin-left": "left" == o.direction ? "-" + s + "px" : a + "px"}), u.trigger("beforeStarting"), l) {
            i.css(b, S);
            var t = w + " { 100%  " + f(n) + "}", p = i.find("style");
...
!function (i) {
  ...
  (e = function () {
    ...
    var t, o, s, n = this;
    !0 === n.options.centerMode ? !0 === n.options.infinite ? (o = n.currentSlide + (n.options.slidesToShow / 2 + 1), s = o + n.options.slidesToShow + 2) : (o = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), s = n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (o = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, s = Math.ceil(o + n.options.slidesToShow), !0 === n.options.fade && (o > 0 && o--, s <= n.slideCount && s++)), e(n.$slider.find(".slick-slide").slice(o, s)), n.slideCount <= n.options.slidesToShow ? (t = n.$slider.find(".slick-slide"), e(t)) : n.currentSlide >= n.slideCount - n.options.slidesToShow ? (t = n.$slider.find(".slick-cloned").slice(0, n.options.slidesToShow), e(t)) : 0 === n.currentSlide && (t = n.$slider.find(".slick-cloned").slice(-1 * n.options.slidesToShow), e(t))
...
var $jscomp = {
  scope: {}, findInternal: function (t, e, a) {
    t instanceof String && (t = String(t));
    for (var n = t.length, r = 0; r < n; r++) {
      var o = t[r];
      if (e.call(a, o, r, t)) return {i: r, v: o}
    }
    return {i: -1, v: void 0}
  }
};
$jscomp.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function (t, e, a) {
  ...
  var e = function (e, a, n) {
    var r = {
      invalid: [], getCaret: function () {
        try {
          var t, a = 0, n = e.get(0), o = document.selection, s = n.selectionStart;
        ...
        for (var t, e, n, r, o = [], i = 0; i < a.length; i++) (t = s.translation[a.charAt(i)]) ? (e = t.pattern.toString().replace(/.{1}$|^.{1}/g, ""), n = t.optional, (t = t.recursive) ? (o.push(a.charAt(i)), r = {
          digit: a.charAt(i),
          pattern: e
        }) : o.push(n || t ? e + "?" : e)) : o.push(a.charAt(i).replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
        ...
        return s.translation[a.charAt(Math.min(t - 1, a.length - 1))] ? Math.min(t + n - e - o, n) : r.caretPos(t + 1, e, n, o)
      }, behaviour: function (a) {
        a = a || window.event, r.invalid = [];
        var n = e.data("mask-keycode");
        if (-1 === t.inArray(n, s.byPassKeys)) {
          var o = r.getCaret(), i = (f = r.val()).length, l = r.getMasked(), c = l.length,
              u = r.getMCharsBeforeCount(c - 1) - r.getMCharsBeforeCount(i - 1), f = o < i && l !== f;
          return r.val(l), f && (8 !== n && 46 !== n ? o = r.caretPos(o, i, c, u) : --o, r.setCaret(o)), r.callbacks(a)
        }
      }, getMasked: function (t, e) {
        var o, i, l = [], c = void 0 === e ? r.val() : e + "", u = 0, f = a.length, p = 0, h = c.length, d = 1,
            v = "push", g = -1;
        n.reverse ? (v = "unshift", d = -1, o = 0, u = f - 1, p = h - 1, i = function () {
          return -1 < u && -1 < p
        }) : (o = f - 1, i = function () {
          return u < f && p < h
        });
        for (var k; i();) {
          var m = a.charAt(u), y = c.charAt(p), M = s.translation[m];
          M ? (y.match(M.pattern) ? (l[v](y), M.recursive && (-1 === g ? g = u : u === o && (u = g - d), o === g && (u -= d)), u += d) : y === k ? k = void 0 : M.optional ? (u += d, p -= d) : M.fallback ? (l[v](M.fallback), u += d, p -= d) : r.invalid.push({
            p: p,
            v: y,
            e: M.pattern
          }), p += d) : (t || l[v](m), y === m ? p += d : k = m, u += d)
        }
        return c = a.charAt(o), f !== h + 1 || s.translation[c] || l.push(c), l.join("")
      }, callbacks: function (t) {
        var o = r.val(), s = o !== i, l = [o, t, e, n], c = function (t, e, a) {
    ...
    e = t(e);
    var o, s = this, i = r.val();
    a = "function" == typeof a ? a(r.val(), void 0, e, n) : a, s.mask = a, s.options = n, s.remove = function () {
      var t = r.getCaret();
      ...
      if (i = i || !1, n = n || {}, s.clearIfNotMatch = t.jMaskGlobals.clearIfNotMatch, s.byPassKeys = t.jMaskGlobals.byPassKeys, s.translation = t.extend({}, t.jMaskGlobals.translation, n.translation), s = t.extend(!0, {}, s, n), o = r.getRegexMask(), i) r.events(), r.val(r.getMasked()); else {
        n.placeholder && e.attr("placeholder", n.placeholder), e.data("mask") && e.attr("autocomplete", "off"), i = 0;
        for (var l = !0; i < a.length; i++) {
          var c = s.translation[a.charAt(i)];
          if (c && c.recursive) {
            l = !1;
            break
          }
        }
        l && e.attr("maxlength", a.length), r.destroyEvents(), r.events(), i = r.getCaret(), r.val(r.getMasked()), r.setCaret(i + r.getMCharsBeforeCount(i, !0))
      }
    }, s.init(!e.is("input"))
  };
  t.maskWatchers = {};
  var a = function () {
    var a = t(this), r = {}, o = a.attr("data-mask");
    ...
    n = n || {};
    var r = t(e).data("mask"), o = JSON.stringify;
    e = t(e).val() || t(e).text();
    try {
      return "function" == typeof a && (a = a(e)), "object" != typeof r || o(r.options) !== o(n) || r.mask !== a
    } catch (t) {
    }
  };
  t.fn.mask = function (a, r) {
    r = r || {};
    var o = this.selector, s = (i = t.jMaskGlobals).watchInterval, i = r.watchInputs || i.watchInputs, l = function () {
      if (n(this, a, r)) return t(this).data("mask", new e(this, a, r))
    };
    return t(this).each(l), o && "" !== o && i && (clearInterval(t.maskWatchers[o]), t.maskWatchers[o] = setInterval(function () {
  ...
  var r = {
    ...
    useInput: function (t) {
      ...
      return t = "on" + t, (e = t in a) || (a.setAttribute(t, "return;"), e = "function" == typeof a[t]), e
    }("input"),
    watchDataMask: !1,
...
!function (t, n) {
  ...
  function i() {
    if (!N) {
      var t, e, i = n("html"), o = l("is-locked");
  ...
  function s(t, n, e, a) {
    var i = l("is", n), o = [l("is", $.CLOSING), l("is", $.OPENING), l("is", $.CLOSED), l("is", $.OPENED)].join(" ");
  ...
  var u, f, g = "remodal", h = t.REMODAL_GLOBALS && t.REMODAL_GLOBALS.NAMESPACE || g,
      v = n.map(["animationstart", "webkitAnimationStart", "MSAnimationStart", "oAnimationStart"], function (t) {
        return t + "." + h
      }).join(" "), C = n.map(["animationend", "webkitAnimationEnd", "MSAnimationEnd", "oAnimationEnd"], function (t) {
        return t + "." + h
      }).join(" "), O = n.extend({
        hashTracking: !0,
        closeOnConfirm: !0,
...
function initMap() {
  map = new google.maps.Map(document.getElementById("map"), {center: {lat: 52.174, lng: 32.847}, zoom: 3});
  new google.maps.Marker({
    position: {lat: 59.889, lng: 30.478},
    map: map
  }), new google.maps.Marker({
    position: {lat: 51.127, lng: 4.948},
    map: map
  }), new google.maps.Marker({position: {lat: 50.905, lng: 6.797}, map: map})
}

!function (e) {
  function n() {
    e(window).scrollTop() > 60 ? (r.addClass("fixed"), e(".fixed-menu").css("margin-top", 60)) : (r.removeClass("fixed"), e(".fixed-menu").css("margin-top", 0))
  }

  function a() {
    e(window).scrollTop() > 60 && (r.removeClass("fixed"), e(".fixed-menu").css("margin-top", 0))
  }

  WebFont.load({google: {families: ["Open Sans"]}}), e(".slider").slick({
    accessibility: !1,
    slideToScroll: !0,
    autoplay: !0,
    infinite: !0,
    ...
    adaptiveHeight: !0,
    dots: !1,
    responsive: [{breakpoint: 992, settings: {dots: !0}}]
  });
  var i = e(".navigation-btn__next"), t = e(".navigation-btn__prev");
  e(".product-slide__slide-envelope").slick({
    slidesToShow: 1,
    slideToScroll: !0,
    autoplay: !0,
    infinite: !0,
    ...
    e(this).children().css("color", "#3f64ae", "transition", "all .7s ease"), e(this).find(".navigation-btn__info").children().css("color", "#3f64ae", "transition", "all .7s ease")
  }), i.on("mouseleave", function () {
    e(this).children().css("color", "#999"), e(this).find(".navigation-btn__info").children().css("color", "#999")
  }), t.on("mouseenter", function () {
    e(this).children().css("color", "#3f64ae", "transition", "all .7s ease"), e(this).find(".navigation-btn__info").children().css("color", "#3f64ae", "transition", "all .7s ease")
  }), t.on("mouseleave", function () {
    e(this).children().css("color", "#999"), e(this).find(".navigation-btn__info").children().css("color", "#999")
  });
  var o = e(".slider-modal").remodal();
  e(".envelope-dataPicture__img").on("click", function () {
    o.open(), e(".slider-modalEnvelope").slick({
      slidesToShow: 1,
      slideToScroll: !0,
      autoplay: !0,
      infinite: !0,
      mobileFirst: !0,
      swipe: !0,
      prevArrow: '<div class="slick-prev modalLeft"><i class="fa fa-angle-left"></i></div>',
      nextArrow: '<div class="slick-next modalRight"><i class="fa fa-angle-right"></i></div>'
    })
  });
  var s = e(".form-connect__input"), l = e('[data-remodal-id="form-modal"]').remodal();
  e(".form-connect__btn-send").on("click", function () {
    for (var e = 0; e < s.length; e++) "" != s[e].value && l.open()
  }), e(".input-phone").mask("(000)-00-000-00"), e(".envelope-dataPicture__miniatures").find("img").on("click", function () {
    e(".envelope-dataPicture__img").attr("src", e(this).attr("src"))
  }), e(".info-order__btn").on("click", function (n) {
    n.preventDefault(), e(".active-btn__bag").removeClass("active-btn__bag"), e(this).addClass("active-btn__bag")
  }), e("#nav-icon1").on("click", function () {
    e(this).toggleClass("open"), e(this).hasClass("open") ? e(".header__menu__wrap--menu").stop(!0).animate({left: "0"}, 700) : e(".header__menu__wrap--menu").stop(!0).animate({left: "-100%"}, 700), e(".header__menu__wrap--search input").hide()
  });
  var r = e(".header__menu");
  e(window).on("load resize", function () {
    e(window).width() <= "768" ? e(window).on("scroll", n) : (e(window).on("scroll", a), r.removeClass("fixed"))
  }), e(".header__menu__wrap--search a").on("click", function (n) {
    n.preventDefault(), e(this).next().stop(!0).fadeToggle(), e(".header__menu__wrap--menu").stop(!0).animate({left: "-100%"}, 700), e("#nav-icon1").removeClass("open")
  }), e(window).on("load resize", function () {
    e(window).width() >= "776" && (e("#nav-icon1").removeClass("open"), e(".header__menu__wrap--menu").stop(!0).animate({left: "-100%"}, 700), e(".header__menu__wrap--search input").hide())
  }), e(".header__contacts__wrap--language a, .footer__wrap__menu__data__other--language a").on("click", function (n) {
    e(this).parent().children().removeClass("active"), e(this).addClass("active")
  }), e(".header__menu__wrap--menu--item a, .footer__wrap__menu__data__other--item a").on("click", function (n) {
    e(this).parent().parent().children().children().removeClass("active"), e(this).addClass("active")
  });
  var c = e('[data-remodal-id="form-callback"]').remodal();
  e(".header__contacts__wrap--callback a, .footer__wrap__menu__data__others--callback a").on("click", function (e) {
    e.preventDefault(), c.open()
  }), e(".buttons").on("click", function (n) {
    n.preventDefault(), e(this).addClass("active_btn"), e(this).parent().siblings().children().removeClass("active_btn")
  }), e(".arrow_left").on("click", function () {
    var n = e(".active_btn"), a = e(".first");
    n.parent().hasClass("first") ? a.children().addClass("active_btn") : (n.removeClass("active_btn"), n.parent().prev().children().addClass("active_btn"))
  }), e(".arrow_right").on("click", function () {
    var n = e(".active_btn"), a = e(".last");
    n.parent().hasClass("last") ? a.children().addClass("active_btn") : (n.removeClass("active_btn"), n.parent().next().children().addClass("active_btn"))
  })
}(jQuery);
var map;