...
function initMap(){map=new google.maps.Map(document.getElementById("map"),{center:{lat:52.174,lng:32.847},zoom:3});new google.maps.Marker({position:{lat:59.889,lng:30.478},map:map}),new google.maps.Marker({position:{lat:51.127,lng:4.948},map:map}),new google.maps.Marker({position:{lat:50.905,lng:6.797},map:map})}!function(e){WebFont.load({google:{families:["Open Sans"]}}),e(".slider").slick({accessibility:!1,slideToScroll:!0,autoplay:!0,infinite:!0,mobileFirst:!0,swipe:!0,adaptiveHeight:!0,dots:!1,responsive:[{breakpoint:992,settings:{dots:!0}}]});var a=e(".navigation-btn__next"),n=e(".navigation-btn__prev");e(".product-slide__slide-envelope").slick({slidesToShow:1,slideToScroll:!0,autoplay:!0,infinite:!0,mobileFirst:!0,swipe:!0,prevArrow:n,nextArrow:a}),a.on("mouseenter",function(){e(this).children().css("color","#3f64ae","transition","all .7s ease"),e(this).find(".navigation-btn__info").children().css("color","#3f64ae","transition","all .7s ease")}),a.on("mouseleave",function(){e(this).children().css("color","#999"),e(this).find(".navigation-btn__info").children().css("color","#999")}),n.on("mouseenter",function(){e(this).children().css("color","#3f64ae","transition","all .7s ease"),e(this).find(".navigation-btn__info").children().css("color","#3f64ae","transition","all .7s ease")}),n.on("mouseleave",function(){e(this).children().css("color","#999"),e(this).find(".navigation-btn__info").children().css("color","#999")});var t=e(".form-connect__input"),i=e('[data-remodal-id="form-modal"]').remodal();e(".form-connect__btn-send").on("click",function(){for(var e=0;e<t.length;e++)""!=t[e].value&&i.open()}),e(".input-phone").mask("(000)-00-000-00"),e(".envelope-dataPicture__miniatures").find("img").on("click",function(){e(".envelope-dataPicture__img").attr("src",e(this).attr("src"))}),e(".info-order__btn").on("click",function(a){a.preventDefault(),e(".active-btn__bag").removeClass("active-btn__bag"),e(this).addClass("active-btn__bag")}),e("#nav-icon1").on("click",function(){e(this).toggleClass("open"),e(this).hasClass("open")?e(".header__menu__wrap--menu").stop(!0).animate({left:"0"},700):e(".header__menu__wrap--menu").stop(!0).animate({left:"-100%"},700),e(".header__menu__wrap--search input").hide()}),e(".header__menu__wrap--search a").on("click",function(a){a.preventDefault(),e(this).next().stop(!0).fadeToggle(),e(".header__menu__wrap--menu").stop(!0).animate({left:"-100%"},700),e("#nav-icon1").removeClass("open")}),e(window).on("load resize",function(){e(window).width()>="776"&&(e("#nav-icon1").removeClass("open"),e(".header__menu__wrap--menu").stop(!0).animate({left:"-100%"},700),e(".header__menu__wrap--search input").hide())}),e(".header__contacts__wrap--language a, .footer__wrap__menu__data__other--language a").on("click",function(a){e(this).parent().children().removeClass("active"),e(this).addClass("active")}),e(".header__menu__wrap--menu--item a, .footer__wrap__menu__data__other--item a").on("click",function(a){e(this).parent().parent().children().children().removeClass("active"),e(this).addClass("active")});var o=e('[data-remodal-id="form-callback"]').remodal();e(".header__contacts__wrap--callback a, .footer__wrap__menu__data__others--callback a").on("click",function(e){e.preventDefault(),o.open()}),e(".buttons").on("click",function(a){a.preventDefault(),e(this).addClass("active_btn"),e(this).parent().siblings().children().removeClass("active_btn")}),e(".arrow_left").on("click",function(a){var n=e(".active_btn"),t=e(".first");n.parent().hasClass("first")?t.children().addClass("active_btn"):(n.removeClass("active_btn"),n.parent().prev().children().addClass("active_btn"))}),e(".arrow_right").on("click",function(a){var n=e(".active_btn"),t=e(".last");n.parent().hasClass("last")?t.children().addClass("active_btn"):(n.removeClass("active_btn"),n.parent().next().children().addClass("active_btn"))})}(jQuery);var map;